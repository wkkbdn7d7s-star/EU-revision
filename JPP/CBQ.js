...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  questionEl.textContent = "Loading Competency-Based Questions...";

  // --- Load questions dynamically from Firestore ---
  try {
    const masterDocRef = doc(db, "questions", "masterQuestions");
    const colRef = collection(masterDocRef, "EUcompetencies"); // subcollection name
    ...
    console.log(`Loaded ${questions.length} EU Competency questions.`);
    shuffleQuestions();
  } catch (error) {
